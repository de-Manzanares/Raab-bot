 ...
 * @param ch The character representation of the piece to promote the pawn to,
...
/**
 * @brief Counts the total number of nodes in the tree starting from the node
 ...
 * @param depth Pointer to the depth variable, which will be updated during
 * traversal
 * @return The next step node from the current node to the end node
 * @warning The function will result in an infinite loop if the current node is
 * not a parent of the end node
 */
