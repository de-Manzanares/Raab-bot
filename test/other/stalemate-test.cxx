...
std::string test_smt(const std::string &fen) {
...
TEST_CASE("black to move") {
  SECTION("https://lichess.org/EQEInzg9/black#59") {
    s = test_smt("r4b1r/pp3k2/P7/2p3pp/4n3/3p3K/4q2P/n7 b - - 0 30");
    stalemate = "b7a6";
    CHECK(!uciloop::simon_says(&s, stalemate)); // don't choose stalemate
  }
  SECTION("https://lichess.org/rT2Ny1Vb/black#105") {
    s = test_smt("8/3k4/1p5p/3b4/2r2p2/1p6/3K4/7q b - - 1 53");
    stalemate = "h1f1";
    CHECK(!uciloop::simon_says(&s, stalemate)); // don't choose stalemate
  }
}
