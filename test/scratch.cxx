...
{
    board.import_fen("8/1KP5/8/8/8/8/5pk1/8 w - - 0 1");
    board.move(s::c7, s::c8, 'q');
    CHECK(board.export_fen() == "2Q5/1K6/8/8/8/8/5pk1/8 b - - 0 1");
    board.import_fen("8/1KP5/8/8/8/8/5pk1/8 w - - 0 1");
    board.move(s::c7, s::c8, 'r');
    CHECK(board.export_fen() == "2R5/1K6/8/8/8/8/5pk1/8 b - - 0 1");
    board.import_fen("8/1KP5/8/8/8/8/5pk1/8 w - - 0 1");
    board.move(s::c7, s::c8, 'b');
    CHECK(board.export_fen() == "2B5/1K6/8/8/8/8/5pk1/8 b - - 0 1");
    board.import_fen("8/1KP5/8/8/8/8/5pk1/8 w - - 0 1");
    board.move(s::c7, s::c8, 'n');
    CHECK(board.export_fen() == "2N5/1K6/8/8/8/8/5pk1/8 b - - 0 1");

    board.import_fen("8/1KP5/8/8/8/8/5pk1/8 b - - 0 2");
    board.move(s::f2, s::f1, 'q');
    CHECK(board.export_fen() == "8/1KP5/8/8/8/8/6k1/5q2 w - - 0 3");
    board.import_fen("8/1KP5/8/8/8/8/5pk1/8 b - - 0 2");
    board.move(s::f2, s::f1, 'r');
    CHECK(board.export_fen() == "8/1KP5/8/8/8/8/6k1/5r2 w - - 0 3");
    board.import_fen("8/1KP5/8/8/8/8/5pk1/8 b - - 0 2");
    board.move(s::f2, s::f1, 'b');
    CHECK(board.export_fen() == "8/1KP5/8/8/8/8/6k1/5b2 w - - 0 3");
    board.import_fen("8/1KP5/8/8/8/8/5pk1/8 b - - 0 2");
    board.move(s::f2, s::f1, 'n');
    CHECK(board.export_fen() == "8/1KP5/8/8/8/8/6k1/5n2 w - - 0 3");
}
