 ...
 */
struct Diagonals {
    static std::vector<std::vector<Square>> leftRight;  ///< left to right {diagonal,{squares}}
    static std::vector<std::vector<Square>> rightLeft;  ///< right to left {diagonal,{squares}}
};
...
struct Maps {
    ...
    std::unordered_map<Square, std::vector<Square>> white_moves{};          ///< all legal white moves
    std::unordered_map<Square, std::vector<Square>> black_moves{};          ///< all legal black moves
    void clear();
};
...
struct Board {
    ...
    Square copy_influence(Color c, std::unordered_map<Square, std::vector<Square>> *from,
